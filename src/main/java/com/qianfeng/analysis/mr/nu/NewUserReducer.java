...
//从map端传来的  是 java 2018 new_user   uuid1
//                  ios  3018 new_user   uuid2
...
//用于uuid去重的集合
    ...
    protected void reduce(StatsUserDimension key, Iterable<TimeOutputValue> values, Context context) throws IOException, InterruptedException {
        ...
        //设置KPI
        this.v.setKpi(KpiType.valueOfKpiName(key.getStatsCommonDimension().getKpi().getKpiName()));//结果是new_user或者browser_new_user
